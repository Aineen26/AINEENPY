...
while current_page:
    try:
        # 1. Attempt the request with a timeout
        ...
        for q in quotes:
            try:
                # 3. Handle missing elements (if a quote had no author, for example)
        ...
        if next_button:
            ...
            time.sleep(1)  # Polite scraping: wait 1 second between pages
        else:
            current_page = None
